...
public class AddComplaint extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			pst = conn.prepareStatement("INSERT INTO complaint(consumer_id,complaint,comp_date)VALUES(" + consId + ",'"
					+ complaint + "','" + timestamp + "')");
			int flag = pst.executeUpdate("INSERT INTO complaint(consumer_id,complaint,comp_date)VALUES(" + consId + ",'"
					+ complaint + "','" + timestamp + "')");
