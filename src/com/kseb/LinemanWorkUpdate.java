...
public class LinemanWorkUpdate extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			/*
			 * Cookie ck[]=request.getCookies(); String
			...
			out.println(
					"<h3>Materials required</h3><textarea name=\"materials\" id=\"materials\" cols=\"30\" rows=\"10\" placeholder=\"Enter required Materials\"></textarea>");
