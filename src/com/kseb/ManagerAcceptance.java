	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			pst = conn.prepareStatement(
					"UPDATE complaint SET comp_status=\"Materials Allotted\" WHERE consumer_id='" + cons_id + "'");
			int flag = pst.executeUpdate(
					"UPDATE complaint SET comp_status=\"Materials Allotted\" WHERE consumer_id='" + cons_id + "'");

			pst = null;
			pst = conn
					.prepareStatement("UPDATE material SET material_eng_accepted=2 WHERE material_id='" + reqID + "'");
